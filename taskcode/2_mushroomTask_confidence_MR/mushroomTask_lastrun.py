...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='Y:\\fMRI Projects\\fMRI Project Mushroom\\data_collection\\taskcode\\2_mushroomTask_confidence_MR\\mushroomTask_lastrun.py',
