...
function import_wave1_dataRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of import_wave1_dataComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function loop_informedConsentLoopBegin(loop_informedConsentLoopScheduler) {
  ...
  for (const thisLoop_informedConsent of loop_informedConsent) {
...
function practice_phasesLoopBegin(practice_phasesLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPractice_phase of practice_phases) {
...
function loop_instrPracLoopBegin(loop_instrPracLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_instrPrac of loop_instrPrac) {
...
function loop_instrPrac2LoopBegin(loop_instrPrac2LoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_instrPrac2 of loop_instrPrac2) {
...
function loop_prTrialsLoopBegin(loop_prTrialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_prTrial of loop_prTrials) {
...
function loop_prSamplesLoopBegin(loop_prSamplesLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_prSample of loop_prSamples) {
...
function loop_instrBonusLoopBegin(loop_instrBonusLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_instrBonu of loop_instrBonus) {
...
function loop_samplesLoopBegin(loop_samplesLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_sample of loop_samples) {
...
function informedConsentRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of informedConsentComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instr_questionnaireRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instr_questionnaireComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function personality_statementsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of personality_statementsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function feedback_traitsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of feedback_traitsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function set_practicePhaseRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of set_practicePhaseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instrPracRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrPracComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instrPrac2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrPrac2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function setupSamplesRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of setupSamplesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function crossHairRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of crossHairComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function mushroomSampleRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of mushroomSampleComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function firstEstimationRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of firstEstimationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function SIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of SIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function tooLate_feedbackRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of tooLate_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test_questionsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of test_questionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instrBonusRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrBonusComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function end_tooLateRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of end_tooLateComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function showBonusRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of showBonusComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function commentsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of commentsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
