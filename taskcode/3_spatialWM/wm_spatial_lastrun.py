...
# Run 'Before Experiment' code from code_constants
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='Z:\\fMRI Projects\\fMRI Project Mushroom\\data_collection\\taskcode\\3_spatialWM\\wm_spatial_lastrun.py',
...
text_continue = visual.TextStim(win=win, name='text_continue',
    ...
    languageStyle='LTR',
    depth=-2.0);
# Run 'Begin Experiment' code from code_constants
