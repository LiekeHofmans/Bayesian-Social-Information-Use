...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='Z:\\fMRI Projects\\fMRI Project Mushroom\\data_collection\\taskcode\\1_mushroomTask_confidence_practice\\mushroomTask_lastrun.py',
...
# Run 'Begin Experiment' code from code_start
...
img_forest = visual.ImageStim(
    win=win,
    name='img_forest', 
    image='img_forest.png', mask=None, anchor='center',
...
img_bags = visual.ImageStim(
    win=win,
    name='img_bags', 
    image='img_bags.png', mask=None, anchor='center',
    ori=0.0, pos=(0, -0.15), size=(0.6153, 0.338),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
img_fields = visual.ImageStim(
    win=win,
    name='img_fields', 
    image='img_fields.png', mask=None, anchor='center',
    ori=0.0, pos=(0, -0.15), size=(0.6153, 0.338),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
screenshotE1 = visual.ImageStim(
    win=win,
    name='screenshotE1', 
    image='screenshot_E1.png', mask=None, anchor='center',
...
screenshotConfidenceRating = visual.ImageStim(
    ...
    image='screenshot_confidenceRating.png', mask=None, anchor='center',
...
img_otherVillage = visual.ImageStim(
    ...
    image='img_otherVillage.png', mask=None, anchor='center',
...
screenshot1 = visual.ImageStim(
    win=win,
    name='screenshot1', 
    image='screenshot_SI1.png', mask=None, anchor='center',
...
screenshot2 = visual.ImageStim(
    win=win,
    name='screenshot2', 
    image='screenshot_SI2.png', mask=None, anchor='center',
    ori=0.0, pos=(0, -0.15), size=(0.643, 0.447),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-10.0)
...
continueRoutine = True
# update component parameters for each repeat
# Run 'Begin Routine' code from import_data
...
for thisPractice_phase in practice_phases:
    ...
    for thisLoop_prTrial in loop_prTrials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        # Run 'Begin Routine' code from set_up_samples
        # retrieved from file
        if startGame == 0:
        ...
        for thisComponent in setupSamplesComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # Run 'End Routine' code from set_up_samples
        sample_index = 0
        ...
        continueRoutine = True
        # update component parameters for each repeat
        # Run 'Begin Routine' code from when_to_continue_3
        ...
        while continueRoutine:
            ...
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            # Run 'Each Frame' code from when_to_continue_3
            #if pic_done == 0:
            #    win.getMovieFrame()
        ...
        for thisComponent in firstEstimationComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # Run 'End Routine' code from when_to_continue_3
        #win.getMovieFrame()
        ...
        continueRoutine = True
        # update component parameters for each repeat
        # Run 'Begin Routine' code from pick_and_show_estimate
        event.clearEvents()
        ...
        # Run 'Begin Routine' code from when_to_continue_2
        ...
        while continueRoutine:
            ...
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            # Run 'Each Frame' code from when_to_continue_2
        ...
        for thisComponent in SIComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # Run 'End Routine' code from when_to_continue_2
        #win.getMovieFrame()
        #win.saveMovieFrames('response.png') 
        kb.clearEvents()
