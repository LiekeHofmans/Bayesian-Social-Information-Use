...
# sudo mount -t cifs "//fmgstorage.fmg.uva.nl/psychology$/fMRI Projects/fMRI Project Mushroom" /home/lhofman/fmgmount -o username=lhofman,domain=uva,noexec,uid=$(id -u),gid=$(id -g)
...
dir_raw='/home/lhofman/Projects/mushroom_tux/raw_data' # where your raw data files can be found
dir_bids='/home/lhofman/Projects/mushroom_tux/bids' # where your bidsified data should go
